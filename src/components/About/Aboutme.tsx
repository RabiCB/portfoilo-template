...
const Aboutme = () => {
  ...
  return (
    <section id="about" className="relative py-8 lg:py-12 xl:py-20 px-4 sm:px-8 lg:px-12 bg-navy-800 text-white overflow-hidden bg-violet-500 bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-600">
